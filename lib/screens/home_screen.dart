...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      onRefresh: ()async {
        getIt<MedicalBloc>().add(const FetchDoctors(),);
        getIt<MedicalBloc>().add(const FetchCategories(),);
        },
        ...
        builder: (context, authState) {
          return BlocBuilder<MedicalBloc, MedicalState>(
            ...
            builder: (context, medicalState) {
              ...
              availableDoctors= getAvailableDoctors(medicalState.doctors);
              return Scaffold(
                drawer: const NavBar(),
                ...
                body: Column(
                  children: [
                    ...
                    Expanded(
                      child: availableDoctors.isNotEmpty? ListView.builder(
                        ...
                        itemBuilder: (context, index) => Container(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              context.go(
                                  "/patientHome/doctors/all/doctorDetails/${availableDoctors[index].id}");
                            },
                            child: DoctorWidget(
                              size: size,
